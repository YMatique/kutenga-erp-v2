...
export default function CustomerCreate() {
    const { data, setData, post, processing, errors } = useForm({
        ...
        credit_limit: 0,
        is_active: true,
        contacts: [{ name: '', role: '', phone: '', email: '' }] as Contact[],
        addresses: [{ type: 'billing' as const, address: '', city: '' }] as Address[],
    });
    ...
    return (
        <>
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h1 className="text-xl font-semibold text-zinc-900 dark:text-zinc-100">Registar Novo Cliente</h1>
                </div>
            </div>
            ...
            <form onSubmit={submit} className="space-y-6">
                ...
                <div className="flex items-center justify-end gap-3">
                    ...
                    <Button type="submit" disabled={processing} className="gap-2 min-w-[180px]">
                        <Save size={16} />
                        {processing ? 'A guardar...' : 'Registar Cliente'}
                    </Button>
                </div>
            </form>
        </>
